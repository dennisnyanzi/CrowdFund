                            ...
                            <div class="tab-content" >
                                ...
                                <div class="tab-pane fade <?php if(auth()->check()): ?> show active <?php endif; ?>" id="nav-profile" role="tabpanel">
                                    ...
                                    <form method="post" action="<?php echo e(route('frontend.event.payment.confirm')); ?>" enctype="multipart/form-data">
                                        ...
                                        <?php if(get_static_option('event_terms_and_conditions') && get_static_option('event_privacy_policy')): ?>
                                            <!-- Terms and Conditions -->
                                            <div id="termsAndConditions">
                                                <label>
                                                    <input type="checkbox" name="agreeTerms" required>
                                                    I agree to the <a href="<?php echo e(route('frontend.dynamic.page',[getSlugByPageId(get_static_option('event_terms_and_conditions')), get_static_option('event_terms_and_conditions')])); ?>" target="_blank">terms and conditions</a> and <a href="<?php echo e(route('frontend.dynamic.page',[getSlugByPageId(get_static_option('event_privacy_policy')), get_static_option('event_privacy_policy')])); ?>" target="_blank">privacy policy</a>.
                                                </label>
                                            </div>
                                        <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fundorex-v1.4.0/@core/resources/views/frontend/events/event-booking.blade.php ENDPATH**/ ?>